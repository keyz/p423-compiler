...
;;   expose-allocation-pointer  l-25 -> l-26 ;; [a8 mod]
;;   uncover-frame-conflict     l-26 -> l-27 ;; [a8 mod]
...
;;   expose-memory-operands     l-37 -> l-38 ;; [a8 mod]
;;   expose-basic-blocks        l-38 -> l-39
...
(p423-grammars
 ...
 (l26-expose-allocation-pointer ;; [a8 mod]
  (%remove 
   (Effect set!))
  (%add
   (Effect
...
; assign-frame: This is the same as l29-assign-new-frame
 ...
 (l38-expose-memory-operands  ;; [a8 mod]
  (%remove (Effect mset! set!))
  (%add 
   (Effect
    (set! Loc Triv)
